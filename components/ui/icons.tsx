...
export const Icons = {
  ...
  Lock: (p: IconProps) => (
    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" {...p}>
  ...
  Notebook: (p: IconProps) => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" {...p}>
      ...
      <path d="M5 8h-2M5 12h-2M5 16h-2M10 8h6M10 12h6" />
    </svg>
  ),
  Copy: (p: IconProps) => (
  ...
  Star: (p: IconProps) => (
    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}>
      <path d="M12 4l2.5 5 5.5.8-4 4 1 5.5-5-2.7-5 2.7 1-5.5-4-4 5.5-.8z" />
    </svg>
  ),
  Pen: (p: IconProps) => (
